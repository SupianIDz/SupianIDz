<div align="center">
  ...
  <p>
    <a href="https://www.octopy.dev" target="_blank">
      <img src="https://img.shields.io/badge/Website-octopy.dev-blue?style=for-the-badge&logo=google-chrome&logoColor=white" alt="Website" />
    </a>
  </p>
</div>
...
- 🐙 **[@gettako](https://github.com/gettako)** — An independent ecosystem under the Octopy ID umbrella. Because Tako is a specialized Go framework with its own extensive ecosystem, it lives in this dedicated space.
...
> *Note: WakaTime tracking started recently, so statistics are still growing.*
